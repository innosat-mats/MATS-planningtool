...
#generate_operational_mode(DT.datetime(2026,8,6,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,7,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,8,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,9,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,10,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,11,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,12,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)

#generate_operational_mode(DT.datetime(2026,8,13,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,14,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,15,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,16,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,17,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,18,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,19,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)

#generate_operational_mode(DT.datetime(2026,8,20,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,21,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,22,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,23,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,24,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,25,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
#generate_operational_mode(DT.datetime(2026,8,26,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)

# generate_operational_mode(DT.datetime(2026,8,27,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,8,28,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,8,29,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,8,30,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,8,31,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,9,1,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,9,2,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)

# generate_operational_mode(DT.datetime(2026,9,3,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,9,4,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,9,5,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,9,6,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
# generate_operational_mode(DT.datetime(2026,9,7,0,0),24,'1109',name='CROPFN',yaw=True,iterate=0,tle = tle)
