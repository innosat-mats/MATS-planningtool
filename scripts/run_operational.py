...
# generate_operational_mode(DT.datetime(2023,2,17,18,00),23,'1105',name='CROPD')
# generate_operational_mode(DT.datetime(2023,2,18,18,00),23,'1105',name='CROPD')
# generate_operational_mode(DT.datetime(2023,2,19,18,00),23,'1105',name='CROPD')
# generate_operational_mode(DT.datetime(2023,2,20,18,00),23,'1105',name='CROPD')
# generate_operational_mode(DT.datetime(2023,2,21,18,00),23,'1105',name='CROPD')
# generate_operational_mode(DT.datetime(2023,2,22,18,00),12,'1105',name='CROPD')
